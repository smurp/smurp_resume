...
Examples of his work include:
  a publishing automation system for YellowPage-sized real estate directories;
  real-estate systems featuring geodata and powered by his own RETS implementation; 
  ...
  a Laboratory Information Management System for disease diagnosis which 
    captured, processed, summarized, categorized, presented and reported
    on disparate scientific data streams; 
...
\title{ CTO }
\location{ Saltspring Island, BC and Edmonton, AB}
