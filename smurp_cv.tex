...
\begin{position}
  Founded think-tank devising game-theoretically robust pathways
  through the singularity --- establishing intellectual priority on
  AI alignment, nanotech and biotech hazards before the field existed
\end{position}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{jobs/ecocity.tex}
\begin{position}
  Founded, sat on the board, authored materials and attended international
  conferences regarding ecological design, education, legislative reforms and
  urban initiatives.
\end{position}
